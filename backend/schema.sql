...
INSERT INTO data_center_readings (data_center, temperature, sector, room)
SELECT data_center, temperature, sector, room
FROM (
    VALUES
    ('Permafrost Norte', 24.7, 'Infraestrutura', 'Sala 01'),
    ('Permafrost Sul', 31.4, 'Backup', 'Sala 02'),
    ('Permafrost Leste', 36.2, 'Processamento', 'Sala 03')
) AS seed_data(data_center, temperature, sector, room)
